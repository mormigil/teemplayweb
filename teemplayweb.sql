...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `description` mediumtext NOT NULL,
  `votes` int(11) NOT NULL,
  `votes_influence` int(11) NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `pass`, `level`, `description`, `votes`, `votes_influence`, `email`) VALUES
(1, 'first', 'awesomepass', 11, '1000dkdkdksafsdf$id, $username, $password, $level, $description, $votes, $salt, $email', 24, 0, 'a@2.com'),
(2, 'bob', 'paasss', 1, '10', 24, 0, 'ankh579@yahoo.com'),
(3, 'mormigil', 'fireforge5', 1, '', 24, 0, 'ankh579@yahoo.com'),
(4, 'mormigil', 'fireforge5', 1, '', 24, 0, 'ankh579@yahoo.com'),
(5, 'mormigil', '828bffe71ef561122ed90c292b57de03fd9aa60566e00c1be682588b60338369036fa36581464ef83b5ef086a8e7657b7a5cbedec455cb00f6bf7cde3431f34f', 1, '', 24, 0, 'ankh579@yahoo.com'),
(6, 'ankhar', '$2a$08$RSCt8syNK4X/ZtfxUICyueGXM5ZTtTS6ICjCngRSyq1jv44UnjImm', 1, '', 31, 2, 'ankh579@yahoo.com'),
(7, 'ankhar', '$2a$08$a1D.8ZFa2E1GVb9/H9mHZ.p4s0n4X1hjBrPZVu/Hydg6/8..Yijuu', 1, '', 24, 0, 'ankh579@yahoo.com'),
(8, 'ankhar', '$2a$08$r6yZiOuh8BI15dihhj.2nexNWQZzrSYFu2iPCn7TwVDKs3m4GsH26', 1, '', 24, 0, 'ankh579@yahoo.com'),
(9, 'ankhar', '$2a$08$T1F/KIGnLcgaeFv7cqr34eIuWe4XV2XaGxcc.9p5lZm0Py8m5G9Yu', 1, '', 24, 0, 'ankh579@yahoo.com'),
(10, 'ankhar', '$2a$08$KCgfJYilefSCDyG0aC0RaeshBWnd2gz8ly3lCtYvm0o1OgREOrlPC', 1, '', 24, 0, 'ankh579@yahoo.com'),
(11, 'ankhar', '$2a$08$z54.i3s.SVJHflpj5WZoHOkiqBctr9ryf8icox0IPgJ0xBK7HrePu', 1, '', 24, 0, 'ankh579@yahoo.com'),
(13, 'ankhar', '$2a$08$1cCag3Fxb3K6FCXPsYAV0OynK4Vgjp7gm52Y/mjTYXpYhxZlT.m5u', 1, '', 24, 0, 'ankh579@yahoo.com'),
(15, 'mormigil', '$2a$08$7BbGhGkLwmmmVqYIVIUzXeQ80sn0nlLP4jFex9i3smS4ovAtKTkF.', 1, '', 24, 0, 'ankh579@yahoo.com'),
(16, 'mormigil', '$2a$08$gfNbTVbSUgU0BDBpQu3xR..aYW7Gu7andlpE0fg7ltj6QoHRmZ71i', 1, '', 24, 0, 'ankh579@yahoo.com'),
(17, 'mormigil', '$2a$08$njJGhxkDUMLL0ndbhcOrU.TMoKSWp9t3Am9AIPPq5xSrYK7p4P82a', 1, '', 24, 0, 'ankh579@yahoo.com'),
(18, 'mormigil', '$2a$08$A8qVr1DVCvP8X4iSIwSGfet8VlrF8dnQaB9d96NrqlmRUJo1D8w1e', 1, '', 24, 0, 'ankh579@yahoo.com'),
(19, 'a', '$2a$08$6pEpkYeBBsn9hr1NraUwc.V5nTGSigbgYcBYQcJ/jTsOd/HpF/r3q', 1, '', 24, 0, 'ankh579@yahoo.com'),
(20, 'b', '$2a$08$wMYRo3lLp8.LUs1rHhKH/.o0MsqEeSJ5FMmv4MdWLNjkCTSffxW9G', 1, '', 24, 0, 'ankh579@yahoo.com'),
(21, 'c', '$2a$08$xTAWwp5RwthVpvNaVbXl8Om8DJKStifx6Niql1WwSh6ACdWPqcvCS', 1, '', 24, 0, 'ankh579@yahoo.com'),
(22, 'd', '$2a$08$ytml5E8w2y2tMC/dWsPEmuRpt8RqUJaST68AoIvuBrcTNUGhIsDgO', 1, '', 24, 0, 'ankh579@yahoo.com'),
(23, 'd', '$2a$08$lXk1VMEl3UNBn1zQD8GM7OjgC5eA9zxWGAAb0AfSIcsPz4FgKYdYa', 1, '', 24, 0, 'ankh579@yahoo.com'),
(24, 'e', '$2a$08$AxwV7v8u/3vErYWrbSyBjuOym6am4cpsJfqCdqySyf8kxQDCOKrAO', 1, '', 24, 0, 'ankh579@yahoo.com'),
(25, 'f', '$2a$08$vSmvxs40hF4H3UZ9rFt6CupqIIM4xGRRx4CubheCq7R79/hK/DkNu', 1, '', 24, 0, 'ankh579@yahoo.com'),
(26, 'g', '$2a$08$fgAMUvHgv2AgeNLBpvpH.OXKLIMebZE6Nlr80.DvyVDPyKUiWphxG', 1, '', 24, 0, 'ankh579@yahoo.com'),
(27, 'z', '$2a$08$sEBPh9pzEPTtUZh18YNRX.aptct3EcSwUwIEZvyvL16TUH3cwyKi.', 1, '', 24, 0, 'ankh579@yahoo.com'),
(28, 'steven', '$2a$08$uxiF5..Ln3bBd7JhZJ0RC.CCIecnVTAT/o/CsvC9yQjoAaPe.llhO', 1, '', 24, 0, 'steve@teemplay.com');
